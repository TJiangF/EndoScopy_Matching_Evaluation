...
import random
import numpy as np
from src.utils.image_keypoints_extractors import extract_image_keypoints, enhance_image
            ...
            if transformation == "rotation":
                ...
                for b in range(0, len(keypoints) - 1):
                    ...
                    if (
                        ...
                        curr_output_folder = osp.join(export_folder, f"{triplet_counter}")
                ...
                if((idx%10==0) & (idx != 0)):
                    print("num of picture: ",idx)
                    print("num of features extracted: ",triplet_counter)
                    # print(triplet_counter)
            # # -------------------------------scaling-----------------------------------------------------------------------------------
            # elif T == 'z':
